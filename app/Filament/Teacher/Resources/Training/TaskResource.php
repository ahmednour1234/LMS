...
use App\Filament\Teacher\Resources\Training\TaskResource\Pages;
    ...
    public static function form(Form $form): Form
    {
        ...
        return $form->schema([
            ...
            Forms\Components\Select::make('lesson_id')
                ...
                ->options(function (Forms\Get $get) use ($teacherId) {
                    ...
                    return Lesson::query()
                        ->whereHas('section', fn (Builder $q) => $q->where('course_id', $courseId)->whereHas('course', fn ($c) => $c->where('owner_teacher_id', $teacherId)))
                        ->orderBy('id')
                        ->get()
