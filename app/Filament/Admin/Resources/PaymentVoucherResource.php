...
use App\Filament\Admin\Resources\PaymentVoucherResource\Pages;
...
class PaymentVoucherResource extends Resource
{
    ...
    {
        return __('navigation.payment_vouchers');
    }

    public static function getModelLabel(): string
    {
        return __('vouchers.types.payment');
    }
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->modifyQueryUsing(function (Builder $query) {
                $query->where('voucher_type', VoucherType::PAYMENT->value);
            })
            ->columns([
