            ...
            Forms\Components\Select::make('section_id')
                ...
                ->relationship(
                    ...
                    modifyQueryUsing: fn (Builder $query) => $query
                        ->with('course:id,code')     // ✅ عشان label
                        ->orderBy('order')
                )
                // ✅ Label موحّد (Course Code + Section ID + ar/en)
                ->getOptionLabelFromRecordUsing(fn (CourseSection $record) => static::sectionLabel($record))
                // ✅ بحث على ar/en + course.code + ids
                ->searchable()
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->modifyQueryUsing(function (Builder $query) {
                // لو عايز eager load لتقليل الاستعلامات:
            ...
            ->filters([
                // ✅ Filter Section بنفس اللابل الموحد
