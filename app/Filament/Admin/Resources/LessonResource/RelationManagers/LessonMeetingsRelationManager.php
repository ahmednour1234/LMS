...
class LessonMeetingsRelationManager extends RelationManager
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->emptyStateHeading('No meetings available yet')
            ->emptyStateDescription('Meetings will be managed here in a future phase.')
            ->headerActions([
