...
return [
    ...
    'description' => 'Student Authentication and Management API. All authentication uses the students table with JWT tokens.',
    ...
    'auth' => [
        ...
        'extra_info' => 'To authenticate, include the JWT token in the Authorization header as: <code>Authorization: Bearer {your_token}</code>. You can obtain a token by logging in via the <code>POST /api/v1/student/login</code> endpoint.',
    ],
